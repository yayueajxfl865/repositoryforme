...
<script type="text/javascript">
	...
	function stuManage(){//学生管理
		...
		window.location.href="${ctx }/queue/queue/authorityNext";
	}
	function handleForm(){//经办管理
		i = layer.msg("正在加载，请稍候...", {icon: 16,rate: 'top',time: 0});
	...
	<form method="post" action="">
		<div class="panel admin-panel">
			<div class="panel-head">
				<strong class="icon-reorder">角色分配</strong>
			</div>
			<div class="padding border-bottom" style="height: 90%;margin-top: 20px;margin-left: 30px;">
				<table style="width: 50%">
					<tr>
						...
						<td>
							<div class="form_title_div" style="float: left;cursor: pointer;" onclick="handleForm()">
								<span>经办管理</span>
							</div>
						</td>
					</tr>
